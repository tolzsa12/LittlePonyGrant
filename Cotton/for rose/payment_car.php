...
<head>
    ...
    function fetch_price(val) {
        ...
        $("#mydata").val(y); //เงินรวมไม่รวม tax
        $("#mytax").val(tax);
        $("#myday").val(days);
        }
...
<!--book_detail-->
    <div class="book_detail">
        ...
        <div class="row"><!--for flexing-->
            ...
            <form action="ajaxData_car.php" method="post">
                ...
                <div class="section-input">
                    <div class="part-input grid2">
                        <div class="left-part">
                            <ul class="input">
                            <div class="main_box">
                            <br><h4>Car Reservation</h4>
                            <div class="box input-box flex_room">
                                <div class="left">
                                <div class="inputBx">
                                    <label for="type_room">Select car :</label>
                                    <select class="type_room form-control" name="room_no" id="room_no" onchange="fetch_price(this.value)" required >
                                        ...
                                        <?php
                                            $sql = mysqli_query($conn,"SELECT * FROM list_booking WHERE Partial_Type_Booking_ID = 2 ORDER BY Booking_ID");
