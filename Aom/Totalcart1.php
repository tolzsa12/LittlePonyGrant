<?php
    ...
    session_start();
    require 'dbconnect.php';// เข้าถึงตัวแปรหรือ method ต่างๆ ผ่าน $db_handle
    if(isset($_POST["cart"]))
    {
        ...
        if(!empty($_SESSION["shopping_cart"]))
        {
            ...
            <section class="finist-total-price">
                <div class="total-price">
                    ...
                    <div class="price-info">
                        <h3>Total price</h3>
                        <p class="pricetotal">THB <?php echo number_format($totalall, 2); ?></p>
                    </div>
                </div>

                <form name="go_to_all_booking" action="PaymentInCart.php" method="post">
                    <input class='Button_summit' type="submit" id="booking" name="booking" value="Booking">
                </form>
            </section>
            <?php
        }
