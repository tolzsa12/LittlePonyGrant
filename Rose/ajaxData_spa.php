<?php 
    ...
    if (isset($_POST['booking'])) {
        ...
        if ($main_reference_number_result) {
            ...
            $partial_reference_number_sql = "INSERT INTO partial_reference_number (Reference_PartialNumber,ReferenceNumber,Booking_ID,MemberGuest,CheckInDateTime,CheckOutDateTime,Staff_ID) VALUES ('','$ReferenceNumber','$room_no','1','$check_in_date','$stamp','100001')";
