...
<!--book_detail-->
    <div class="book_detail">
        ...
        <div class="row"><!--for flexing-->
            ...
            <form action="ajaxData_spa.php" method="post">
                ...
                <div class="section-input">
                    <div class="part-input grid2">
                        <div class="left-part">
                            <ul class="input">
                            <div class="main_box">
                            <br><h4>Spa Reservation</h4>
                            <div class="box input-box flex_room">
                                <div class="left">
                                <div class="inputBx">
                                    <label for="type_room">Select spa course :</label>
                                    <select class="type_room form-control" name="room_no" id="room_no" onchange="fetch_price(this.value)" required >
                                        <option selected disabled value="">Select spa course</option>
                                        
                                        <?php
                                            $sql = mysqli_query($conn,"SELECT * FROM list_booking WHERE Partial_Type_Booking_ID = 1 ORDER BY Booking_ID");
                                    ...
                                    <div class="inputBx">
                                        ...
                                        <input id="number_guest" type="number" name="MemberGuest2" placeholder="Number guest" selected disabled value="1" require>
                                        <input type="hidden" name="MemberGuest" value = "1">;
                                    </div>
                                </div>
                                <div class="right">
                        ...
                        <div class="right-part">
                            ...
                            <table style="width: 85%;">
                                ...
                                <tr>
                                    <td><h6 class="total-day" style="font-weight: bold">Spa course reservation <span name="staying_day" id="staying_day"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>
