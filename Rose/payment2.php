                                ...
                                <div class="box input-box flex_room">
                                    <div class="left">
                                        ...
                                        <div class="inputBx">
                                            ...
                                            <input type="date" placeholder="mm/dd/yyyy" id="check_in_date" name="check_in_date" max="" data-error="Select Check In Date" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        ...
                                        <script>
                                            ...
                                            var dates = ["16-05-2022", "18-05-2022", "20-05-2022"];
                                        ...
                                        <div class="inputBx">
                                            ...
                                            <input type="date" placeholder="mm/dd/yyyy" id="check_out_date" name="check_out_date" min="" onchange="calculateDays()" data-error="Select Check Out Date" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    ...
                                    <div class="right">
                                        <div class="inputBx">
                                            ...
                                            <input id="MemberGuest" type="number" name="MemberGuest" placeholder="Member guest" require>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="inputBx">
